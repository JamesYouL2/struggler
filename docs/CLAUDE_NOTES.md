...
Flag-only events (NATO, Formosan Resolution, Shuttle Diplomacy) still value 0:
the sandbox measures influence and immediate VP, and a persistent effect is
neither. Left alone deliberately, as it needs expert judgement about what
those effects are worth rather than a mechanical fix.
