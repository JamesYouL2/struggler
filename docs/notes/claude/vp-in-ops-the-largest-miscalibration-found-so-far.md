...
board's Ops value moves (then `vp_early` 0.5, `vp_mid` 1.0, `vp_late` 2.0, replaced on 2026-09-11 by the smooth `vp_base`/`vp_swing` curve -- see "Win probability is the objective; VP is the currency"; a
