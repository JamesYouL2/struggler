...
- [The intransitivity was the access scale leak, and it flips sign](2026-09-21-the-intransitivity-was-the-access-scale.md) — 2026-09-21 (the fitted weights go from -0.031 to +0.038 against the same anchor once access follows the fit; both seats gain, the USSR more; next is bc5ef93)
