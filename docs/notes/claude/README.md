...
- [Step 4: when does a hand stop having an exit?](2026-09-19-last-exit-instrument.md) — 2026-09-19 (certain corners are rare and fatal, 1 in 64 seat-games; the USSR tail is the thing to move)
