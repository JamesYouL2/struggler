...
- [Cheaper readings: a shard cache, sequential waves, and 6% off the bot](2026-09-21-cheaper-readings.md) — 2026-09-21 (a re-dispatched shard becomes free; a decided arm stops at half its seeds for 2% of the final interval; three exact speedups worth 5.9%, and the float-regrouping that nearly went in with them)
