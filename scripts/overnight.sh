...
. "$ROOT/scripts/lib/queue_common.sh"  # run_ab, shared with overnight2.sh
...
run_ab "vp-swing-4x" '{"version": 1, "weights": {"vp_swing": 4.0}}' \
  "7000-7127" "7128-7255" "4x vp_swing against the shipped 2x, 256 seeds" \
...
run_ab "ablate-access" '{"version": 1, "weights": {"access": 0.01}}' \
  "7300-7427" "7428-7555" "Ablating the access family to 1%, 256 seeds" \
