...
# The drift canary's opening rule: shared by scripts/drift_check.sh (local)
# and .github/workflows/drift.yml (CI), so the two cannot disagree about
# which anchors play which books.
#
